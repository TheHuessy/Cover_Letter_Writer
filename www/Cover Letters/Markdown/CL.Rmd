...
pb <- " because I am looking to advance my career in data analysis and lend my skills and talents to one of the most prolific, data oriented companies in the world." #<-- This is going to be the place where you want to put the write in option for what the last sentence there
...
#Then Company/Division
pd <- " would give me all of these opportunities and enable me to continue my career in data science."
...
ppppa <- "Now, as I near the end of my graduate studies, I feel that I have outgrown my former roles and want to seek a new challenge, working with even larger datasets, developing insights that can further the mission of the company. I want to brave the new frontier in my budding data science career and working at "
